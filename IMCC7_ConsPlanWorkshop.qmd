...
Define CRS
```{r}
cCRS <- "ESRI:54009" # Mollweide projection
```
...
# Spatial Prioritisation using real datasets

> To save time, we have pre-prepared the data for this workshop, but here we provide a brief overview of the types of data you will see, and what packages you can use to process them. Spatial data usually takes one of two forms— vector and raster.    
...
> ## Applications of marine conservation planning
...
Galapagos Movement Consortium, Movebank Data Repository <https://www.movebank.org/cms/movebank-main> Harris, P.T., Macmillan-Lawler, M., Rupp, J. and Baker, E.K., 2014. Geomorphology of the oceans. Marine Geology, 352, pp.4-24.
