...
| Advanced Spatial Prioritisation      | 10:30-11:40     | Sandra |
| Going beyond Code      | 11:40-11:50 | Jase |
| Wrap up; Q&A | 11:50-12:00   | Ant and Sandra|
...
We are using the Galapagos EEZ as our *planning region* (i.e., study area) and we have already created our *planning units* (i.e., smallest unit of the analysis) as hexagonal grids of 200km2 area. We are defining our projection as the Mollweide Equal-Area projection.
The `PUs` object contains planning units represented as spatial polygons (i.e., a `sf::st_sf()` object). This object has two columns that denote the ID (`cellID`) and the outline of each planning unit (`geometry`).
...
# Appendix 1: Creating your own spatial data
