...
**Please follow the software installation instructions in @sec-appendix1 before you attend the workshop.**
...
| Going beyond Code                       | 12:00-12:15   | Jase/Alvise    |
...
For the purpose of this workshop, we recommend using on of the freely available solvers that are supported by `prioritizr` and are easily installed, such as the SYMPHONY solver, which can be easily installed.
